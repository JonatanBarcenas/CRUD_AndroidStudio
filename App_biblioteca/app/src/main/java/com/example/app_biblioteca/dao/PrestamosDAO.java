...
public class PrestamosDAO {
    ...
    public static void guardarDatos(Context context, ArrayList<Prestamo> prestamos) {
        try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream(new File(context.getFilesDir(), "prestamos.txt")))) {
    ...
    public static ArrayList<Prestamo> cargarDatos(Context context) {
        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream(new File(context.getFilesDir(), "prestamos.txt")))) {
